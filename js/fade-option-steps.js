...
export const fadeHalfLife = {
  ...
  updateValueTitle: (v) => {
    ...
    document.getElementById('fadeHalfLifeTitle').innerText = fadeHalfLife.steps[step].title;
  },
};
...
export const minFavIconOpacity = {
  ...
  updateValueTitle: (v) => {
    ...
    document.getElementById('minFavIconOpacityTitle').innerText = minFavIconOpacity.steps[step].title;
  },
};
...
export const fadeTimeToReset = {
  ...
  updateValueTitle: (v) => {
    ...
    document.getElementById('fadeTimeToResetTitle').innerText = fadeTimeToReset.steps[step].title;
  },
};