...
(async () => {
  const { fadeIconViaWorker, getFaviconUrl, resetIcon } = await import(chrome.runtime.getURL("js/util-dom.js"));
  ...
  async function handleVisibilityChange() {
    try {
      ...
      console.log('PING timestamp:', timestamp, 'page ' + document.visibilityState);
    } catch (err) {
